...
class Transcriber:
    ...
    def __init__(self, model: Optional[str] = None) -> None:
        ...
        if mlx_whisper is None:
            raise ModelError("mlx_whisper is not installed. Install it with: pip install mlx-whisper")
    ...
    def _load_model(self) -> None:
        ...
        if self._model is None:
            try:
                ...
                raise ModelError(f"Failed to load Whisper model '{self.model_name}': {e}") from e
